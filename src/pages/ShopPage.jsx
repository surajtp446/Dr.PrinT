...
import { ChevronLeft, ChevronRight, ShoppingCart, X, Check } from 'lucide-react';
    ...
    <div className="min-h-screen bg-black text-white pt-24 pb-24">
      ...
      <div className="max-w-6xl mx-auto px-6">
        <motion.div initial="hidden" animate="visible" variants={fadeUp} className="mb-14 text-center">
          ...
          <p className="text-white/35 text-sm font-light max-w-xs mx-auto leading-relaxed">
        ...
        <motion.div initial="hidden" animate="visible" variants={fadeUp} custom={6}
          className="border border-white/08 p-10 text-center">
          <p className="text-[10px] tracking-[0.5em] text-white/22 uppercase mb-3">Something Specific in Mind?</p>
          <h2 className="text-2xl font-black mb-3">Custom Orders</h2>
          <p className="text-white/35 text-sm font-light max-w-xs mx-auto mb-6 leading-relaxed">
            Send us your file. We print it your way.
          </p>
          <Link to="/custom"
            className="inline-block px-8 py-3 border border-white/25 text-white text-[10px] font-black uppercase tracking-widest hover:bg-white hover:text-black transition-all duration-300">
